...
import { readWorkingTree, readCommit, isGitRepo, repoRoot } from "../src/providers.mjs";
import { scanFiles, diffStates, selectTiers, failing, VERSION } from "../src/crosscheck.mjs";
import { renderScan, renderDiff, githubAnnotations, githubSummary } from "../src/format.mjs";
...
function parseArgs(argv) {
  ...
  if (!["text", "json", "github"].includes(opts.format)) throw usage(`--format must be text, json or github`);
